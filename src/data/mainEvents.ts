    ...
    options: [
      {
        id: "enjoy-stage",
        label: "무대 앞에서 즐긴다",
        resultText: "무대 앞에서 뛰었다.\n노래는 좋았고 체력은 조용히 퇴장했다.",
        effects: [
      ...
      },
      {
        id: "booth",
        label: "학과 부스를 돕는다",
        resultText: "학과 부스를 도왔다.\n봉사인지 노동인지 애매했지만 얼굴은 확실히 팔렸다.",
        effects: [
          { target: "social", value: 15 },
          { target: "teamContribution", value: 5 },
      ...
      {
        id: "library",
        label: "축제를 피해 도서관에 간다",
        resultText: "도서관으로 피신했다.\n밖은 축제였고 안은 기말고사의 예고편이었다.",
        effects: [
          { target: "grade", value: 8 },
